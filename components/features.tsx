      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            Built for the Future of Training and Development
            </h2>
            <p className="text-lg text-blue-200/65">
            SimVizLabs combines cutting-edge technology with user-centric design to deliver flexible and powerful solutions for training and development. Our platform's advanced features make learning and skill acquisition efficient, scalable, and secure.
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              Create lifelike virtual environments that replicate real-world conditions, providing learners with immersive experiences.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-blue-200/65">
              Track learner progress and make informed decisions using detailed analytics and reporting tools.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-blue-200/65">
              Adapt the platform to your unique training needs with customizable workflows and integrations.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-blue-200/65">
              Easily connect with existing systems and data sources to ensure consistency and efficiency in training.
