        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 text-center md:pb-20">
            <h1
              ...
              data-aos="fade-up"
            >
              Revolutionize Skill Development with Immersive Virtual Training
            </h1>
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={200}
              >
                SimVizLabs bridges the gap between traditional training and digital convenience, delivering cutting-edge simulation tools for a seamless learning experience.
              </p>
